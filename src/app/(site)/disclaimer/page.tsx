  ...
  return (
    <section className="section space-y-6">
      ...
      <div className="card space-y-4 text-sm text-sand/80 leading-relaxed">
        ...
        <p>
          References to partnerships or business opportunities are not offers of employment. Engagements are subject to
          due diligence, mutual agreement, and compliance with applicable laws.
        </p>
        <p>
